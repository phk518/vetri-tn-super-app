...
export type ServiceType = keyof typeof SERVICE_METADATA;
...
export const SERVICE_METADATA: Record<string, {
  ...
  SCHEME_TRACKING: {
    displayName: 'Scheme Tracking',
    displayNameTamil: 'திட்ட கண்காணிப்பு',
    icon: '💳',
    departmentCode: 'WELFARE',
    defaultDurationMinutes: 43200, // 30 days
    formFields: [
      { name: 'beneficiary_name', label: 'Beneficiary Name', labelTamil: 'பயனாளியின் பெயர்', type: 'text', required: true },
      { name: 'scheme_name', label: 'Scheme Name', labelTamil: 'திட்டத்தின் பெயர்', type: 'select', required: true, options: ['Kalaignar Magalir Urimai Thogai', 'Pudhumai Penn Scheme', 'Chief Minister’s Comprehensive Health Insurance'] },
      { name: 'district', label: 'District', labelTamil: 'மாவட்டம்', type: 'text', required: true },
      { name: 'bank_last_four', label: 'Bank A/c Last 4 Digits', labelTamil: 'வங்கி கணக்கின் கடைசி 4 இலக்கங்கள்', type: 'number', required: true },
    ],
  },
  COMPLAINT_FILING: {
    displayName: 'Complaint Filing',
    displayNameTamil: 'புகார் பதிவு (CM Cell)',
    icon: '📢',
    departmentCode: 'CM_CELL',
    defaultDurationMinutes: 21600, // 15 days
    formFields: [
      { name: 'applicant_name', label: 'Complainant Name', labelTamil: 'புகார்தாரர் பெயர்', type: 'text', required: true },
      { name: 'category', label: 'Category', labelTamil: 'பிரிவு', type: 'select', required: true, options: ['Water Supply', 'Electricity', 'Roads & Infrastructure', 'Corrupt Practices'] },
      { name: 'description', label: 'Description', labelTamil: 'விளக்கம்', type: 'text', required: true },
      { name: 'location_pincode', label: 'Pincode', labelTamil: 'அஞ்சல் குறியீடு', type: 'number', required: true },
    ],
  },
};
